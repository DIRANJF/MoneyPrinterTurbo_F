...
class VideoAspect(str, Enum):
    ...
    def to_resolution(self):
        if self == VideoAspect.landscape_16_9.value:
            return 1920, 1080
        elif self == VideoAspect.portrait_9_16.value:
            return 1080, 1920
        elif self == VideoAspect.square_1_1.value:
            return 1080, 1080
        elif self == VideoAspect.landscape_4_3.value:
            return 1440, 1080
        elif self == VideoAspect.portrait_3_4.value:
            return 1080, 1440
        elif self == VideoAspect.landscape_21_9.value:
            return 2560, 1080
        return 1080, 1920
...
class VideoParams(BaseModel):
    ...
    video_aspect: Optional[VideoAspect] = VideoAspect.portrait_9_16.value
    ...
    # Subtitle animation
    subtitle_animation: Optional[str] = "fade"
